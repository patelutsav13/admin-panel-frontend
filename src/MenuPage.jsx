...
export default function MenuPage() {
  ...
  const handleEdit = async (e) => {
    ...
    try {
      const res = await fetch(`${import.meta.env.VITE_API_URL}/api/foods/${editingId}`, {
        method: 'PUT',
        body: formData
      });
            ...
            <form onSubmit={isEditing ? handleEdit : handleAdd} className="space-y-4" encType="multipart/form-data">
              <div>
                ...
                <input
                  ...
                  className="w-full p-3 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-500 outline-none transition"
                  value={name}
              ...
              <div>
                ...
                <select
                  className="w-full p-3 bg-slate-50 border border-slate-200 rounded-lg focus:bg-white focus:ring-2 focus:ring-indigo-500 outline-none transition appearance-none"
                  value={category}
