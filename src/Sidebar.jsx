...
export default function Sidebar({ onLogout, isOpen, toggleSidebar }) {
  ...
  return (
    <div className={`w-64 bg-slate-900 dark:bg-gray-950 text-white min-h-screen flex flex-col fixed left-0 top-0 h-full shadow-2xl z-40 font-sans transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
